function [S1, I1, R1, Q1 W] = sir_v1_simulate(s1_0, i1_0, r1_0, q1_0, beta, gamma, num_steps)
...
%   q1_0 = initial number of quarantined individuals (v1)
%
...
for step = 2 : num_steps
    [s1, i1, r1] = sir_v1_step(s1, i1, r1, q1, beta, gamma);
    S1(step) = s1;
    I1(step) = i1;
    R1(step) = r1;
    Q1(step) = q1;
