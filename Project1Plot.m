...
r1_0 = 0; 
wash = 1/10; %proportion of susceptible population washing hands
num_steps = 40; % Number of weeks Simulated

[S,I,R,W]=sir_v1_simulate(s1_0, i1_0, r1_0, beta, gamma, num_steps, wash);
...
[S2,I2,R2,W]=sir_v2_simulate(s2_0, i2_0, r2_0, delta, epsilon, num_steps, m, s2_m, i2_m, r2_m, wash);
