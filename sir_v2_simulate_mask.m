function [S2, I2, R2, W] = sir_v2_simulate_mask(s2_0, i2_0, r2_0, delta, epsilon, num_steps, m, s2_m, i2_m, r2_m, masks)
...
for step = m : num_steps
    [s2, i2, r2] = sir_v2_step_mask(s2, i2, r2, delta, epsilon, masks);
    S2(step) = s2;
    I2(step) = i2;
    R2(step) = r2;
end
